// lib/features/letters/widgets/letter_editor.dart
...
/// A form used to create or edit a Letter.
///
    ...
    return GlassmorphicCard(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text(
              isEdit ? Strings.lettersEdit : Strings.lettersAdd,
            ...
            TextFormField(
              ...
              validator: (value) {
                if (value == null || value.trim().isEmpty) {
                  return Strings.lettersTitleValidation;
                }
                return null;
              },
